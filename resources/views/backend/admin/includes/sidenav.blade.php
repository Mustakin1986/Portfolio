...
<!-- Contact Form Start--->
            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#socialmedia" aria-expanded="false" aria-controls="collapseLayouts">
                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                Social Media
                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
            </a>
            <div class="collapse" id="socialmedia" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" href="{{ route('socialMedia.create') }}">Create</a>
                    <a class="nav-link" href="{{ route('socialMedia.index') }}">List</a>
                </nav>
            </div>
